    ...
    <main className="min-h-full">
        <div className="md:flex md:align-middle lg:flex lg:align-middle p-4 ">
            <div className="text-center px-6 md:px-5 py-5 md:pt-28 lg:pt-28">
                <h2 className='text-5xl py-2 text-white md:text-5xl mb-6 font-semibold font-mono'>Hello, my name is <span className="text-[#1DB67D] animate-pulse hover:animate-bounce">Cornelius</span>.</h2>
                ...
                <div className="mt-8 flex justify-center gap-2 text-white text-3xl">
