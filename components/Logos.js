...
export default function Logos(){
    ...
    //         <span className="text-4xl mx-4 "> <a href="https://shopamargaret.com/" className="text-fold">AMARGARET</a> </span>
    //         <span className="text-4xl mx-4 font-mono">Asomani</span>
    //         <span className="text-4xl mx-4 font-mono">Hale Options</span>
    //         <span className="text-4xl mx-4 font-mono">The Chill Resort</span>
    //         <span className="text-4xl mx-4 font-mono">LarryJay Ghana</span>
    //         </div>
