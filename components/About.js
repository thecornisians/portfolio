        ...
        // bg-[#2B69B3]
                <section className='p-4 smooth-scroll bg-[#ebf1f8] mb-5'  id="about">
                    <div className="lg:flex lg:flex-row-reverse align-center justify-center scroll-smooth sm:gap-10 ">
                      ...
                      <div className=" text-xl sm:mb-5 max-w-4xl align-middle my-9 text-center p-3">
                        <h3 className="text-4xl mb-12 font-extrabold text-center lg:text-right">About Me</h3>
                          <p className="font-md md:font-xl md:text-left mb-2 text-center">I am a Full stack Software Engineer who loves building products that help make the world a little better. Skilled in solving problems with HTML, CSS, JavaScript, React, Nextjs, Node, Express, MongoDB. 
                          </p>
                          <p className="font-md md:font-xl md:text-left mb-2 text-center" >A lifelong learner with interests spanning different disciplines. We can have a chat about psychology, philosophy, Economics, Physics, etc. I write about my learnings in my weekly newsletter  <a href="https://cowans.substack.com" rel="noreferrer" className="text-[#1DB67D]" target='_blank'>here. </a>
