...
export default function About() {
  return (
    // bg-[#2B69B3]
    <section className="p-4 smooth-scroll bg-black text-white mb-5 " id="about">
        ...
        <div className=" text-md md:text-xl sm:mb-5 max-w-4xl align-middle my-9 text-center p-3">
          ...
          <p className="font-md md:font-xl md:text-left mb-2 ">
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#1DB67D]"
              target="_blank"
            >
              here.{" "}
            </a>
            When I am not writing code, you can find me listening to or making
            music. I occassionaly also write and direct short films/ creative
      ...
      <section className="text-center">
        <h3 className=" text-2xl md:text-4xl md:mb-12 font-extrabold">
