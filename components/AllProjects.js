              ...
              <div>
                      <div className='flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
                          ...
                          <div className='basis-1/3 flex-1 mb-3'>
                            ...
                            <div className='flex gap-3 mt-2'>
                                <a className="px-1.5 py-1.5 mr-2 text-white rounded-md bg-gray-800 hover:bg-gray-400 text-sm" href='https://github.com/thecornisians/nanaasomani-website'>Github Repo</a>
                          ...
                          <div className='basis-1/3 flex-1 mb-3'>
                              ...
                              <div className='flex gap-3 mt-2'>
                                <a className="px-1.5 py-1.5 mr-2 text-white rounded-md bg-gray-800 hover:bg-gray-400 text-sm" href='#' target='_blank' rel="noreferrer">Github Repo</a>
                                <a  className="px-1.5 py-1.5 mr-2 text-white rounded-md bg-gray-800 hover:bg-gray-400 text-sm" href='https://thechillgh.com/' target='_blank' rel="noreferrer">Live Site</a>
                              </div>
                          </div>
                          <div className='basis-1/3 flex-1 mb-3'>
                              ...
                              <div className='flex gap-3 mt-2'>
                                <a className="px-1.5 py-1.5 mr-2 text-white rounded-md bg-gray-800 hover:bg-gray-400 text-sm" href='#' target='_blank' rel="noreferrer">Github Repo</a>
                                <a  className="px-1.5 py-1.5 mr-2 text-white rounded-md bg-gray-800 hover:bg-gray-400 text-sm" href='https://shopamargaret.com/' target='_blank' rel="noreferrer">Live Site</a>
                              </div>
                          </div>
                          ...
                          <div className='basis-1/3 flex-1 mb-3'>
                            ...
                            <div className='flex gap-3 mt-2'>
                               <a className="px-1.5 py-1.5 mr-2 text-white rounded-md bg-gray-800 hover:bg-gray-400 text-sm" href='#' target='_blank' rel="noreferrer">Github Repo</a>
                              <a className="px-1.5 py-1.5 mr-2 text-white rounded-md bg-gray-800 hover:bg-gray-400 text-sm" href='https://larryjayghana.com/'target='_blank' rel="noreferrer">Live Site</a>
                              </div>
                          </div>
                          ...
                          <div className='basis-1/3 flex-1 mb-3'>
                            ...
                            <div className='flex gap-3 mt-2'>
                               <a className="px-1.5 py-1.5 mr-2 text-white rounded-md bg-gray-800 hover:bg-gray-400 text-sm" href='#' target='_blank' rel="noreferrer">Github Repo</a>
                              <a className="px-1.5 py-1.5 mr-2 text-white rounded-md bg-gray-800 hover:bg-gray-400 text-sm" href='https://haleoptionz.com/'target='_blank' rel="noreferrer">Live Site</a>
                              </div>
                          </div>
                      </div>
              </div>
