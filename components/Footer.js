...
export default function Footer(){
    return (   
        <footer className="p-4 rounded-lg shadow md:items-center md:justify-between md:p-6 dark:bg-gray-800 md:flex lg:flex">
            <span className="text-md text-gray-500 sm:text-center dark:text-gray-400">© 2022 Cornelius. All Rights Reserved.
            </span>
